...
Improve the app's visual design
Learn conditional styling (making one card look different from the others)

What I did

Added a header section with the title, location, and today's date
Highlighted one prayer card in purple to mark it as the "next" prayer
Added a "Next prayer" label that only appears on the highlighted card
Experimented by moving the highlight between different prayers to see how it works
